...
\newcommand{\myFaculty}{Department of Microbiology, Molecular
  Genetics, and Computer Science\xspace}
...
heightrounded, marginparwidth=4cm, marginparsep=.35cm]{geometry}
...
unicode=true, pdfusetitle,
  bookmarks=true,bookmarksnumbered=true,pdfborder={0 0 1},backref=false,
  ...
  pdfpagemode=UseOutlines, plainpages=false,
